...
export const HomePage = () => {
  ...
  return (
    <>
      <div id="parallax"></div>
      <main className="flex min-h-screen flex-col items-center justify-center pt-40 backdrop-blur-xs sm:mt-30 lg:mt-10 lg:items-start lg:pt-0 lg:pl-20 lg:backdrop-blur-none xl:mt-0 xl:pl-40">
